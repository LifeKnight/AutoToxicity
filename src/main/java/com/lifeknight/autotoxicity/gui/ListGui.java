...
import com.lifeknight.autotoxicity.gui.components.*;
...
import static com.lifeknight.autotoxicity.mod.Core.openGui;
import static com.lifeknight.autotoxicity.utilities.Miscellaneous.*;
...
public class ListGui extends GuiScreen {
    ...
    private final LifeKnightList.LifeKnightStringList lifeKnightStringList;
    ...
    public ListGui(LifeKnightList.LifeKnightStringList lifeKnightStringList) {
        this.lifeKnightStringList = lifeKnightStringList;
        lastGui = null;
    }

    public ListGui(LifeKnightList.LifeKnightStringList lifeKnightStringList, LifeKnightGui lifeKnightGui) {
    ...
    public void initGui() {
        ...
        if (lastGui != null) {
            super.buttonList.add(new LifeKnightButton("Back", 5, getScaledHeight(10), getScaledHeight(10), 50) {
                @Override
                public void work() {
                    openGui(lastGui);
                }
    ...
    protected void removeSelectedButton() {
        try {
           ...
           addField.setSubDisplayMessage(RED + ioException.getMessage());
